...
userRouter.route("/requestReset").post((req, res) => new user_controller_1.UserController().requestReset(req, res));
userRouter.route("/verifyCode").post((req, res) => new user_controller_1.UserController().verifyCode(req, res));
