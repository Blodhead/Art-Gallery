...
class UserController {
    constructor() {
        ...
        this.requestReset = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const user = yield users_1.default.findOne({ email: email }).exec();
        ...
        this.verifyCode = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!email || !code) {
                res.status(400).json({ verified: false, message: 'missing fields' });
                return;
            }
            try {
                const user = yield users_1.default.findOne({ email: email }).exec();
                if (!user || !user.tempPass || !user.timeStamp) {
                ...
                if (user.tempPass !== code) {
                    res.status(400).json({ verified: false, message: 'code incorrect' });
                    return;
                }
