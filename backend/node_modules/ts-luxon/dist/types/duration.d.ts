...
export declare type NormalizedDurationUnit = keyof NormalizedDurationObject;
export declare type NormalizedHumanDurationUnit = Exclude<NormalizedDurationUnit, "quarters" | "weeks">;
