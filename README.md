# Art-Gallery
Full Stack development of a website that uses MEAN structure to work with participants and organizers of art parfumes, with admin supervision.

Some of the features include:
1. Register/Login
2. Password and other user info change
3. Forgot Password sent to user mail
4. Fillter/Sort and top 5 liked parfumes
